...
public interface WeaponData {
	...
	public static double BASICGUN_SIZE = 0.15d, 	BASICGUN_SPEED = 2.5d, 		BASICGUN_COF = 2d, 		BASICGUN_SPEED_SPREAD = 1.5d;
	public static double BASICGUN_DAMAGE = 10d, 	BASICGUN_COOLDOWN = 10d,	BASICGUN_RECOIL = 0.04d;

	public static double SHOTGUN_LEGNTH = 0.08d, 	SHOTGUN_WIDTH = 0.55d;
	public static double SHOTGUN_SIZE = 0.15d, 		SHOTGUN_SPEED = 1.9d, 		SHOTGUN_COF = 2d, 		SHOTGUN_SPREAD = 15d,			SHOTGUN_SPEED_SPREAD = 1d;
	public static double SHOTGUN_DAMAGE = 10d,	 	SHOTGUN_COOLDOWN = 35d,		SHOTGUN_RECOIL = 0.2d;
	public static int SHOTGUN_PELLET_COUNT = 12;

	public static double MACHINEGUN_LEGNTH = 1.2d, 	MACHINEGUN_WIDTH = 0.5d;
	public static double MACHINEGUN_SIZE = 0.15d, 	MACHINEGUN_SPEED = 2.2d, 	MACHINEGUN_COF = 8d, 	MACHINEGUN_SPEED_SPREAD = 2d;
