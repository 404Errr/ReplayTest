...
public interface WeaponData {
	...
	public static double BASICGUN_RECOIL = 0.04d;
	...
	public static double SHOTGUN_RECOIL = 0.2d;
	...
	public static double HITSCAN_INCREMENT = 0.001d, HITSCAN_MAX_DISTANCE = Math.max(Level.getWidth(), Level.getHeight())*3d;
