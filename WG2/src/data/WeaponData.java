...
public interface WeaponData {
	...
	int SHOTGUN_PELLET_COUNT = 16;
	float SHOTGUN_RECOIL = 0.15f;
	float SHOTGUN_RPM = 150f;
	float SHOTGUN_PELLET_DAMAGE = 0.96f/SHOTGUN_PELLET_COUNT;//per pellet
	...
	float FRAGGRENADE_SHARD_RANGE = 7.5f;
	float FRAGGRENADE_GRENADE_RPM = 85f;
	int FRAGGRENADE_GRENADE_TIMER = 1500;
...
//	int FRAGGRENADE_SHARD_COUNT = 0;
	...
	float FRAGGRENADE_SHARD_DAMAGE = 15f/FRAGGRENADE_SHARD_COUNT;
