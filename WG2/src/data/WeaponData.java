...
public interface WeaponData {
	boolean ALL_GUNS_AT_START = true, RECOIL = true, DAMAGE = true;
	int STARTING_GUN = 3;
	...
	float FRAGGRENADE_SIZE = 0.05f;
//	float FRAGGRENADE_SPEED_LO = 0.2f;
//	float FRAGGRENADE_SPEED_HI = 0.8f;
	float FRAGGRENADE_GRENADE_SPEED = 0.4f;
	float FRAGGRENADE_SPEED = 1.0f;
	float FRAGGRENADE_SHARD_SPEED_SPREAD = 0.05f;
	float FRAGGRENADE_RANGE = 5f;
	float FRAGGRENADE_COOLDOWN = 40f;
	int FRAGGRENADE_TIMER = 1500;
	int FRAGGRENADE_SHARD_COUNT = 8;
	float FRAGGRENADE_DAMAGE = 2f/FRAGGRENADE_SHARD_COUNT;
