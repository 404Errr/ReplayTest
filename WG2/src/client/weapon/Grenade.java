...
public enum Grenade implements Weapon, WeaponData {
	FRAGGRENADE(FRAGGRENADE_GRENADE_SPEED, FRAGGRENADE_SPEED, FRAGGRENADE_GRENADE_SIZE, FRAGGRENADE_SIZE, FRAGGRENADE_DAMAGE, FRAGGRENADE_COOLDOWN, FRAGGRENADE_RANGE, FRAGGRENADE_TIMER, FRAGGRENADE_SPEED_SPREAD, FRAGGRENADE_SHARD_COUNT);
